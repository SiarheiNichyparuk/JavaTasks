...
public class StaxMenuParser {
	...
	private static List<Library> process(XMLStreamReader reader)
		...
		while (reader.hasNext()) {
			...
			case XMLStreamConstants.START_ELEMENT:
				...
				case LIBRARY:
					library = new Library();
					library.setId(Integer.parseInt(reader.getAttributeValue(
							null, "ID")));
					break;
				case BOOK:
					book = new Book();
					book.setId(Integer.parseInt(reader.getAttributeValue(null,
							"ID")));
					break;
				case AUTHOR:
					author = new Author();
